...
file_path = filedialog.askopenfilename(initialdir="~/Documents/", filetypes=(('text files', '.txt'),))  # Provide the actual path to your text file
...
def choose_file():
    ...
    new_file_path = filedialog.askopenfilename(initialdir="~/Documents/", filetypes=(('text files', '.txt'),))
